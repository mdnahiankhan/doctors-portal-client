...
const AddDoctors = () => {
    ...
    const { data: specialties, isLoading } = useQuery({
        queryKey: ['specialty'],
        queryFn: async () => {
            const res = await fetch('https://doctors-portal-server-five-omega.vercel.app/appointmentSpecialty');
        ...
        fetch(url, {
            ...
            .then(Imagedata => {
                if (Imagedata.success) {
                    ...
                    fetch('https://doctors-portal-server-five-omega.vercel.app/doctors', {
                        method: 'POST',
                        headers: {
